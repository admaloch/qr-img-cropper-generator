let qrUrl = "https://www.floridamemory.com/items/show/338340#!";
let qrImg;
...
const updateRangeSetting = (id, value) => {
  ...
  if (id === "qr-size") {
    ...
    if (mode2Btn.classList.contains("active")) {
      root.style.setProperty("--cropAmount", value * -0.071 + "px");
    }
...
linkBgToBorderIcon.addEventListener("click", (e) => {
        console.log('link bg to border color')
...
linkborderToBgIcon.addEventListener("click", (e) => {
    console.log('link bord3er to bg color')
...
const resetMainEditSection = () => {
  ...
  document.querySelector("#size-type").selectedIndex = 2;
